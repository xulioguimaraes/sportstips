...
import { Calendar, Clock, Star, Target, Lock, ArrowRight } from 'lucide-react';
...
export default function TipCardPublic({ tip, onClick, onPremiumClick }: TipCardPublicProps) {
  ...
  return (
    <div 
      className={`bg-[#1e293b] rounded-lg shadow-md border border-gray-600 p-4 mb-2 cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] hover:border-brand-500 ${
        tip.isPremium ? 'border-[#FFD700] bg-gradient-to-br from-[#FFD700]/10 via-[#00A651]/5 to-[#FFD700]/8 shadow-[#FFD700]/20 shadow-lg' : ''
      }`}
      onClick={handleClick}
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex-1 min-w-0">
          ...
          <div className="font-semibold text-white text-sm truncate">{tip.teams}</div>
        ...
        <div className="flex items-center space-x-2">
          ...
          {tip.isPremium && (
            <div className={`flex items-center text-xs font-medium transition-all duration-200 ${
              ...
              <span>Assinar</span>
              <ArrowRight className={`w-3 h-3 ml-1 transition-transform duration-200 ${
        ...
        <div className="font-medium text-white text-sm">
          {tip.isPremium ? (
            <div className="flex items-center">
              ...
              <span className="text-[#FFD700] font-medium">Conteúdo Premium</span>
            </div>
          ) : (
            tip.prediction
          )}
