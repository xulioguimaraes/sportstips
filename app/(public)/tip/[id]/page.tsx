...
export default function TipDetailPage() {
  ...
  const fetchTipDetails = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          result.error || result.message || "Erro ao carregar tip"
        );
      }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 py-3 space-y-6">
        {/* Info Card */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-3 px-4">
          <div className="flex justify-between items-center mb-6">
            ...
            {tip.confidence && (
              <div className="bg-gradient-to-r from-blue-500/10 to-blue-500/5 rounded-lg py-2 px-3">
                <div>
                  <div className="text-xs text-gray-600 dark:text-gray-400">
                    Confiança
                  </div>
                  <div className="font-medium text-end text-blue-600 dark:text-blue-400">
                    {tip.confidence}%
                  </div>
                </div>
              </div>
          ...
          {/* Prediction */}
          <div className="bg-gradient-to-r from-[#a3bd04]/10 to-[#a3bd04]/5 rounded-lg py-3 px-4 mb-6">
